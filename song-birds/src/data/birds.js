    ...
    [       
      {
        ...
        description: 'Самая буйная птушка ў атрадзе вераб’інападобных. Апярэнне чорнае, з сінім, зеленаватым ці фіялетавым металічным адлівам (маладыя матавыя). Хвост у палёце заканчваецца клiнам. Дзюба моцная, чорная. Голас: даволi разнастайны, гарлавое «крук, крук» або «крок-крок», «ток» i даволi звонкі «куланг», у маладых — «каа-каа».',
