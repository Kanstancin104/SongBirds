    ...
    [       
      {
        ...
        description: 'Самая буйная птушка ў атрадзе вераб’інападобных. Даўжыня цела 60-67 см, размах крылаў 115-150 см, маса да 1,6 кг. Апярэнне чорнае, з сінім, зеленаватым ці фіялетавым металічным адлівам (маладыя матавыя). Пёры валля падоўжаныя, ланцэтападобныя. Хвост у палёце заканчваецца клiнам. Дзюба моцная, чорная. Голас: даволi разнастайны, гарлавое «крук, крук» або «крок-крок», «ток» i даволi звонкі «куланг», у маладых — «каа-каа».',
      ...
      },
      {
        ...
        name: 'Журавель',
        species: 'Grus grus',
        description: 'Гукі, што робіць журавель, падобныя на гучнае «кур-лы – кур-лы». Жураўли часьцей за ўсё сьпяваюць дуэтам – одна птушка пачынае запеў са складу «кур», а другая падхоплівае «лы». Калі птушка сьпяваа одна, то яна робіць толькі гук «кур».',
      ...
      },
      {
        ...
        description: 'Для ластавак характэрна нягучнае шчабятаньне. Песьни ластавак не змаўкаюць на працягу ўсяго лета. Дасьледчыкі адрозьніваюць у птушак да 6 гукаў: «віт», «ві-віт», «чывіт», «чырывіт» і да т.п. Ластаўкі любяць сьпяваць дуэтам.',
      ...
      },
      {
        ...
        description: 'Звычайны ляляк – непрыкметная птушка, вядомая дзякуючы свайму голасу. Песьня ляляка гучыць як манатонная трэль падобная на тарахценье матацыкла. Такое бразгатаньне чутно ад захаду да сьвітанку, яго танальнасьць, частата й гучнасьць зьмяняюцца. ',
      ...
      },
      {
        ...
        description: 'Птушка сярэдніх памераў. Маладыя птушкі, незалежна ад полу, альбо шараватыя, альбо рудаватыя з больш цёмнай папярочнай паласатасцю па ўсім целе. Кукуе толькі самец. Голас самкі падобны да чалавечага рогату. З-за завостраных крылаў і паласатага малюнка на жываце падчас палёту зязюля падобна да драпежнай птушкі. Дзякуючы гэтаму самец зязюлі палохае птушку-гаспадара гнязда, а ў гэты час самка падкідвае яйка.',
